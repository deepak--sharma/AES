...
this.each(function(){init(this);});};$.fn.jqFancyTransitions.defaults={width:110,height:138,strips:10,delay:4000,stripDelay:50,titleOpacity:0.7,titleSpeed:1000,position:'alternate',direction:'fountainAlternate',effect:'',navigation:false,links:false};})(jQuery);